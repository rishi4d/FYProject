        ...
        <nav class="navbar navbar-expand-sm navbar-dark sticky-top">
            ...
            <div class="mr-auto" id="leftitems">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a  style="color: rgb(190, 190, 190); font-weight: bold;" class="nav-link" href="browse.php">Browse</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="container-fluid" id="sections">
            <div class="row mx-auto">
                <div id="trends" class="col-12 col-sm-12 child">
                    <h4>Top Songs<span id="sectionspan"><a href="#">View All</a></span></h4>
                    <div class="row">
                ...
                <div id="charts" class="col-xs-6 col-12 col-sm-12 child">
                    <h4>Top Albums<span id="sectionspan"><a href="">View All</a></span></h4>
                    <div class="row">
                        <div class="col-xs-6 col-sm-4 col-lg-2">
                            <div class="card">
                                <img id="secimg" src="res/img/127369.jpg">
                ...
                <div id="releases" class="col-12 col-sm-12 child">
                    <h4>Top Playlists<span id="sectionspan"><a href="">View All</a></span></h4>
                    <div class="row">
                        <div class="col-xs-6 col-sm-4 col-lg-2">
                            <div class="card">
                                <img id="secimg" src="res/img/127369.jpg">
                ...
                <div id="artists" class="col-12 col-sm-12 child">
                    <h4>Top Artists<span id="sectionspan"><a href="">View All</a></span></h4>
                    <div class="row">
                        <div class="col-xs-6 col-sm-4 col-lg-2">
                            <div class="card">
                                <img id="secimg" src="res/img/127369.jpg">
